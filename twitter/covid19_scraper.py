...
ID_FILES_ROOT = './twitter_data/UIUC_dataset/'
...
class COVID19_SCRAPER:
    def __init__(self):
        ...
        self.log_file = f'./logs/covid19_scraper_{datetime.now().strftime("%Y%m%d_%H:%M:%S")}.txt'
        ...
        for tweet_id in tqdm(id_list):
                ...
                while not successful:
                    try:
                        ...
                        all_tweets_todb.append([tweet_id, obj['full_text'], obj['created_at'], 
...
# scraper.get_todb_by_file('./twitter_data/UIUC_dataset/2020-01/coronavirus-tweet-id-2020-01-22-12.txt')